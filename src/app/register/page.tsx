    ...
    <div className="!min-h-screen !bg-gradient-to-br !from-slate-950 !via-gray-950 !to-slate-900 !relative !overflow-hidden">
      ...
      <div className="!flex !items-center !justify-center !min-h-screen !p-6 !relative">
        ...
        <div className="!w-full !max-w-2xl !animate-fade-in-up">
                ...
                return (
                  <div key={step.number} className="!flex !items-center">
                    <div className="!relative !flex !items-center !justify-center">
                      <div
                        className={`
                          !w-14 !h-14 !rounded-full !flex !items-center !justify-center !font-bold !text-white !transition-all !duration-500 !relative !z-10
                      ...
                      >
                        <IconComponent className={`!h-7 !w-7 ${isCurrent ? '!animate-pulse' : ''}`} />
                      </div>
                      {isActive && (
                        <div 
          ...
          {/* Registration Card */}
          <div className="!bg-gradient-to-br !from-white/10 !to-white/5 !backdrop-blur-xl !border !border-white/20 !shadow-2xl !rounded-3xl !p-8 lg:!p-12 hover:!shadow-barbershop-red/10 !transition-all !duration-700">
            <form onSubmit={handleSubmit}>
              ...
              {currentStep === 1 && (
                <div className="!space-y-6 !animate-fade-in-up">
                  <div className="!grid !grid-cols-1 !gap-6">
                    <div className="!relative group">
                      ...
                      <div className="!relative">
                        <Building className="!absolute !left-3 !top-1/2 !transform !-translate-y-1/2 !h-5 !w-5 !text-gray-400 group-focus-within:!text-barbershop-red !transition-colors !duration-300" />
                        <input
                          name="barbershopName"
                          ...
                          required
                          className="!w-full !pl-12 !pr-4 !py-4 !bg-white/5 !border-2 !border-white/20 !rounded-xl !text-white !placeholder-gray-400 !text-lg focus:!outline-none focus:!ring-2 focus:!ring-barbershop-red/50 focus:!border-barbershop-red/50 !transition-all !duration-300 !backdrop-blur-sm hover:!bg-white/10 hover:!border-white/30"
                        />
                      </div>
                    </div>
                    ...
                    <div className="!relative group">
                      ...
                      <div className="!relative">
                        <MapPin className="!absolute !left-3 !top-1/2 !transform !-translate-y-1/2 !h-5 !w-5 !text-gray-400 group-focus-within:!text-barbershop-red !transition-colors !duration-300" />
                        <input
                    ...
                    <div className="!grid !grid-cols-1 md:!grid-cols-2 !gap-4">
                      <div className="!relative group">
                        ...
                        <div className="!relative">
                          <Phone className="!absolute !left-3 !top-1/2 !transform !-translate-y-1/2 !h-5 !w-5 !text-gray-400 group-focus-within:!text-barbershop-red !transition-colors !duration-300" />
                          <input
                      ...
                      <div className="!relative group">
                        ...
                        <input
                          ...
                          className="!w-full !px-4 !py-4 !bg-white/5 !border-2 !border-white/20 !rounded-xl !text-white !placeholder-gray-400 !text-lg focus:!outline-none focus:!ring-2 focus:!ring-barbershop-red/50 focus:!border-barbershop-red/50 !transition-all !duration-300 !backdrop-blur-sm hover:!bg-white/10 hover:!border-white/30"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="!w-full !bg-gradient-to-r !from-barbershop-red !to-red-600 !text-white !py-4 !rounded-xl !font-semibold !text-lg hover:!from-barbershop-red/90 hover:!to-red-600/90 !transform hover:!scale-105 !transition-all !duration-300 !shadow-lg hover:!shadow-xl hover:!shadow-barbershop-red/25 disabled:!opacity-50 disabled:!cursor-not-allowed disabled:!transform-none !relative !overflow-hidden group"
                  >
                ...
                <div className="!space-y-6 !animate-fade-in-up">
                  <div className="!grid !grid-cols-1 !gap-6">
                    <div className="!relative group">
                      ...
                      <div className="!relative">
                        <User className="!absolute !left-3 !top-1/2 !transform !-translate-y-1/2 !h-5 !w-5 !text-gray-400 group-focus-within:!text-barbershop-blue !transition-colors !duration-300" />
                        <input
                          name="adminName"
                          ...
                          required
                          className="!w-full !pl-12 !pr-4 !py-4 !bg-white/5 !border-2 !border-white/20 !rounded-xl !text-white !placeholder-gray-400 !text-lg focus:!outline-none focus:!ring-2 focus:!ring-barbershop-blue/50 focus:!border-barbershop-blue/50 !transition-all !duration-300 !backdrop-blur-sm hover:!bg-white/10 hover:!border-white/30"
                        />
                      </div>
                    </div>
                    ...
                    <div className="!relative group">
                      ...
                      <input
                        ...
                        required
                        className="!w-full !px-4 !py-4 !bg-white/5 !border-2 !border-white/20 !rounded-xl !text-white !placeholder-gray-400 !text-lg focus:!outline-none focus:!ring-2 focus:!ring-barbershop-blue/50 focus:!border-barbershop-blue/50 !transition-all !duration-300 !backdrop-blur-sm hover:!bg-white/10 hover:!border-white/30"
                      />
                    </div>
                      ...
                      <div className="!relative group">
                        ...
                        <div className="!relative">
                          <input
                            ...
                            placeholder="••••••••"
                            required
                            className="!w-full !px-4 !pr-14 !py-4 !bg-white/5 !border-2 !border-white/20 !rounded-xl !text-white !placeholder-gray-400 !text-lg focus:!outline-none focus:!ring-2 focus:!ring-barbershop-blue/50 focus:!border-barbershop-blue/50 !transition-all !duration-300 !backdrop-blur-sm hover:!bg-white/10 hover:!border-white/30"
                          />
                          <button
                            type="button"
                  ...
                  <div className="!flex !gap-4">
                    <button
                      ...
                      className="!flex-1 !border-2 !border-white/20 !text-gray-300 !py-4 !rounded-xl !font-semibold hover:!border-white/30 hover:!text-white !transition-all !duration-300 !backdrop-blur-sm"
                    >
                      Anterior
                    </button>
                    <button
                      ...
                      className="!flex-1 !bg-gradient-to-r !from-barbershop-blue !to-blue-600 !text-white !py-4 !rounded-xl !font-semibold hover:!from-barbershop-blue/90 hover:!to-blue-600/90 !transform hover:!scale-105 !transition-all !duration-300 !shadow-lg hover:!shadow-xl hover:!shadow-barbershop-blue/25 disabled:!opacity-50 disabled:!cursor-not-allowed disabled:!transform-none !relative !overflow-hidden group"
                    >
              ...
              {currentStep === 3 && (
                <div className="!space-y-8 !animate-fade-in-up">
                  ...
                  <div className="!space-y-6">
                    <label className="!flex !items-start !text-sm group !cursor-pointer">
                      <input
                        ...
                        onChange={handleInputChange}
                        className="!mr-3 !mt-1 !rounded !border-white/20 !bg-white/5 !text-barbershop-red focus:!ring-barbershop-red !w-4 !h-4"
                        required
                      />
                  ...
                  <div className="!p-6 !bg-gradient-to-r !from-barbershop-blue/10 !to-barbershop-red/10 !border !border-white/10 !rounded-xl !backdrop-blur-sm">
