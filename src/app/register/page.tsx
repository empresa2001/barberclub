      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-lg">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white mt-6 mb-1">Registrá tu barbería</h1>
    ...
    <div className="flex gap-3 pt-2">
      ...
      {onNext && (
        <button type="button" onClick={onNext} disabled={nextDisabled}
          className="flex-1 py-2.5 rounded-xl bg-[#b02e2e] text-white text-sm font-medium hover:bg-[#b02e2e]/85 transition-colors disabled:opacity-40 disabled:cursor-not-allowed">
          {nextLabel || "Siguiente"}
        </button>
      )}
      {submitLabel && (
        <button type="submit" disabled={submitDisabled}
          className="flex-1 py-2.5 rounded-xl bg-[#b02e2e] text-white text-sm font-medium hover:bg-[#b02e2e]/85 transition-colors disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2">
          {isLoading && (
